      ...
      <div className="relative flex items-center justify-between">
        ...
        <ul className="flex items-center hidden space-x-8 lg:flex">
          ...
          <li>
            {isAuthenticated ? (
              <>
                <p className="inline-block px-5 py-3 text-xs font-semibold tracking-wider text-teal-900 uppercase rounded-full bg-social-impact-100">
                  {account?.slice(0, 10)}...
                </p>
                <button
                  onClick={() => {
                  ...
                  className="ml-4 inline-flex items-center justify-center h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-social-impact-200 hover:bg-social-impact-300 focus:shadow-outline focus:outline-none"
                  aria-label="Sign up"
                  title="Logout"
                >
                  Logout
