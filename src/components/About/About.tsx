    ...
    <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      ...
      <div className="grid max-w-screen-lg gap-8 row-gap-10 mx-auto lg:grid-cols-2">
        ...
        <div className="flex flex-col max-w-md sm:mx-auto sm:flex-row">
          ...
          <div>
            <h6 className="mb-3 text-xl font-bold leading-5">Why USDT?</h6>
            <p className="mb-3 text-sm text-gray-900">
              The staking system using AAVE works using an Isolated AAVE USDT
              Pool V3 on the Polygon network, while the Interest of the pool is
              low compared to other assets it's meaningful with the support of
              everyone, and also safer for all us who want to apport some money.
